...
public class BoardService {
	...
	private static Log log = LogFactory.getLog(BoardService.class);
	...
	/** 친구 글 생성 */
	public ResultUtil getFboardList(UserForm userForm, int current_page_no, String function_name) throws Exception {
		log.debug("==================친구 리스트 처리2=========================");
		ResultUtil resultUtil = new ResultUtil();
		CommonDto commonDto = new CommonDto();

		int totalCount = userDao.getFriendCnt(userForm);
		...
		List<BoardDto> list = boardDao.getFboardList(userForm);
